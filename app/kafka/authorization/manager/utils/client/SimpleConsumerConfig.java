...
public class SimpleConsumerConfig extends AbstractConfig {
    ...
    public static final String ENABLE_EMPTY_SUBSCRIPTION_CONFIG = "enable.empty.subscription";
    private static final String ENABLE_EMPTY_SUBSCRIPTION_DOC = "when enabled, this consumer can subscribe to an empty set of topics";
    private static final boolean DEFAULT_ENABLE_EMPTY_SUBSCRIPTION = false;
    ...
    static {
        CONFIG = new ConfigDef().define(BOOTSTRAP_SERVERS_CONFIG,
                                ...
                                .define(ENABLE_EMPTY_SUBSCRIPTION_CONFIG,
                                        Type.BOOLEAN,
                                        DEFAULT_ENABLE_EMPTY_SUBSCRIPTION,
                                        Importance.LOW,
                                        ENABLE_EMPTY_SUBSCRIPTION_DOC
                                        )
    ...
    SimpleConsumerConfig(Map<?, ?> props) {
        super(CONFIG, props);
    }
