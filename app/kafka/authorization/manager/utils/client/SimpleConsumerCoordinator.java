 ...
 */
public final class SimpleConsumerCoordinator extends AbstractCoordinator {

    private static final Logger log = LoggerFactory.getLogger(ConsumerCoordinator.class);

    private final List<PartitionAssignor> assignors;
    private final boolean isExclusiveAssignor;
    ...
    private final LeaderIdHolder leaderIdHolder = new LeaderIdHolder();
    ...
    private Optional<ExclusiveAssignor.Callback> exclusiveAssignorCallback = Optional.empty();

    /**
     * Initialize the coordination manager.
     */
    public SimpleConsumerCoordinator(ConsumerNetworkClient client,
                                     String groupId,
        ...
        this.isExclusiveAssignor = isExclusiveAssignor;
    ...
    public void setExclusiveAssignorCallback(ExclusiveAssignor.Callback callback) {
        this.exclusiveAssignorCallback = Optional.of(callback);
    }
    ...
    protected Map<String, ByteBuffer> performAssignment(String leaderId,
        ...
        leaderIdHolder.setLeaderId(leaderId);
        PartitionAssignor assignor = null;
        if (isExclusiveAssignor)
            assignor = lookupAssignor(ExclusiveAssignor.NAME);
        else
        ...
        if (isExclusiveAssignor) {
            ((ExclusiveAssignor) assignor).setLeaderId(leaderId);
            ((ExclusiveAssignor) assignor).setCallBack(exclusiveAssignorCallback.get());
            assignment = assignor.assign(metadata.fetch(), subscriptions);
        } else {
            assignment = assignor.assign(metadata.fetch(), subscriptions);
        }
